...
def render_withdrawal_requested(
    *,
    ...
    text_lines += [
        ...
        "",
        "Didn't make this request? Email support@powertradefx.com immediately.",
    ]
    return subject, html, "\n".join(text_lines)
...
def render_withdrawal_rejected(
    *,
    ...
    html = render_layout(
        ...
        cta_url="mailto:support@powertradefx.com",
    )
    text_lines = [
        f"Hi {name},",
        "",
    ...
    text_lines += [
        ...
        "once the issue is resolved, or email support@powertradefx.com for help.",
    ]
    return subject, html, "\n".join(text_lines)
