...
contract PowerTradeFXVaultV1Test is Test {
    PowerTradeFXVaultV1 internal vault;
    ...
    function setUp() public {
        ...
        vault = new PowerTradeFXVaultV1(address(usdt), admin);
