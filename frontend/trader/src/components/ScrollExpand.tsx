...
/* Added on install — the registry ships this file without the directive
   because React Bits also targets Vite, but it uses useRef/useEffect and
   reads `window`, so under the App Router it has to be a Client
   Component. Re-add this if you ever pull the component down again with
