  ...
  return (
    <div className="pointer-events-auto flex items-stretch gap-1 select-none">
      <button
        ...
        onClick={() => trade('sell')}
        className="flex flex-col items-center justify-center rounded-md bg-sell hover:bg-sell-light px-3 py-1 text-white shadow-lg disabled:opacity-60 transition-colors"
      ...
      <button
        ...
        onClick={() => trade('buy')}
        className="flex flex-col items-center justify-center rounded-md bg-buy hover:bg-buy-light px-3 py-1 text-white shadow-lg disabled:opacity-60 transition-colors"
        title="Buy at market"
      >
