  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-white px-6">
      <div className="max-w-md w-full text-center">
        <p className="text-xs uppercase tracking-[0.2em] text-text-secondary mb-4">Error 500</p>
        ...
        {error.digest && (
          <p className="text-xs text-text-secondary font-mono mb-6">Reference: {error.digest}</p>
        )}
