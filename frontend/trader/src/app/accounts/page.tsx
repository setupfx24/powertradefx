  ...
  return (
    <DashboardShell>
      ...
      <Modal
        ...
        width="md"
        className="border border-border-primary bg-card shadow-2xl"
      >
        <div className="space-y-4 p-1">
          ...
          <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-2 pt-3 border-t border-border-primary">
            <button
              ...
              className="px-5 py-2.5 rounded-lg border border-border-primary bg-card text-sm font-semibold text-text-primary hover:bg-bg-hover transition-colors"
            >
              Close
            </button>
            <Link
      ...
      <div className="page-main w-full space-y-6">
        <div className="animate-wallet-fund-enter-lg">
          <div className="space-y-5">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                {user?.is_demo ? (
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-full bg-accent px-5 py-2 text-sm font-semibold text-white hover:bg-accent-hover transition-colors"
                  >
                    Open Account
                  </button>
                ) : (
                ...
                <div className="inline-flex items-center gap-1 rounded-full border border-border-primary bg-card p-1">
                  <button
                    type="button"
              ...
              {!loading && error && (
                <div className="space-y-3 rounded-2xl border border-red-500/30 bg-red-500/100/5 p-4 text-center">
              ...
              {!loading && !error && visibleRows.length === 0 && (
                <div className="rounded-2xl border border-border-primary bg-card p-8 text-center">
  ...
  return (
    <div ref={ref} className="relative inline-block" title={title}>
      <button
        ...
        aria-expanded={open}
        className={clsx(
          'inline-flex items-center gap-2 rounded-full border border-border-primary bg-card px-4 py-2 text-sm font-medium text-text-primary hover:border-[#0A0A0A] transition-colors',
      ...
      {open && !disabled && (
        <ul
          role="listbox"
          className="absolute left-0 top-full z-50 mt-2 min-w-[160px] overflow-hidden rounded-xl border border-border-primary bg-card shadow-lg ring-1 ring-white/10"
        >
          {options.map((o) => {
              ...
              <li key={o.id} role="option" aria-selected={selected}>
                <button
                  ...
                  className={clsx(
                    ...
                    selected ? 'bg-bg-tertiary font-semibold text-text-primary' : 'text-text-primary',
                  )}
                >
                  {o.label}
                </button>
...
function JoinCopyTradingCard({ onStart }: { onStart: () => void }) {
  return (
    <div className="md:col-span-2 relative overflow-hidden rounded-2xl ax-card-hero p-6">
      <div className="relative z-[1] flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <button
          type="button"
          onClick={onStart}
          className="inline-flex items-center justify-center rounded-full bg-accent px-5 py-2 text-sm font-semibold text-white hover:bg-accent-hover transition-colors shrink-0"
        >
          Start Copying
        </button>
      </div>
...
function AccountCard({
  ...
  return (
    <div
      ...
      className="ax-card-hero ax-glow-hover rounded-2xl p-5"
    >
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="rounded-full p-1.5 text-text-tertiary hover:bg-bg-hover hover:text-text-primary transition-colors"
          >
            <Settings size={18} />
          </button>
          {menuOpen && (
            <div className="absolute right-0 top-9 z-20 w-44 rounded-xl border border-border-primary bg-card py-1 shadow-lg">
              <button
                type="button"
        ...
        <div className="mt-4 flex flex-wrap items-center justify-end gap-2">
          ...
          {!row.is_demo && (
            <button
              type="button"
              onClick={onDeposit}
              className="inline-flex items-center justify-center gap-1.5 rounded-full bg-accent px-4 py-2 text-sm font-semibold text-white hover:bg-accent-hover transition-colors"
            >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 rounded-full border border-border-primary bg-card px-4 py-2 text-sm font-semibold text-text-primary hover:border-accent hover:text-accent transition-colors"
          >
            <TrendingUp size={15} />
