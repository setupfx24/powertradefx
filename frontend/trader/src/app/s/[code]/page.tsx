    ...
    >
      ...
      {loading ? (
        ...
        <>
          ...
          {data.description && (
            <div className="w-full max-w-sm md:max-w-md mt-6 p-4 rounded-xl bg-card/5 border border-white/10">
              <p className="text-white/90 text-sm leading-relaxed">{data.description}</p>
            </div>
          )}

          {data.link_description && (
            <div className="w-full max-w-sm md:max-w-md mt-4 p-4 rounded-xl bg-card/5 border border-white/10">
