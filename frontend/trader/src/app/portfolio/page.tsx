  ...
  return (
    ...
    <DashboardShell>
      <div className="page-main space-y-4 sm:space-y-6 text-text-primary">
          ...
          {accountOptions.length > 0 && (
            <label className="flex items-center gap-2 text-sm">
              ...
              <select
                ...
                className="rounded-lg border border-border-primary bg-card px-3 py-2 text-sm font-medium text-text-primary outline-none focus:border-accent cursor-pointer"
        ...
        {invalidAccountParam ? (
          <div className="rounded-xl border border-amber-500/35 bg-amber-500/100/10 px-4 py-3 text-sm text-text-primary">
        ...
        {validAccountId ? (
          <div className="rounded-xl border border-accent/30 bg-accent/10 px-4 py-3 flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-wider text-accent">Account scope</p>
        ...
        {tab === 'overview' && (
          ...
          <div className="rounded-2xl border border-border-primary bg-card overflow-hidden">
                    ...
                    <button
                      ...
                      className={clsx(
                        ...
                        n === page
                          ...
                          : 'bg-card text-text-secondary border-border-primary hover:bg-bg-hover',
                      )}
                    >
                      {n}
                    </button>
