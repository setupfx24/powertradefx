  ...
  return (
    <DashboardShell>
      <div className="mx-auto w-full max-w-3xl px-4 sm:px-6 py-6 sm:py-10 space-y-6 sm:space-y-8">
        ...
        {/* ─── Hero Header ─── */}
        <div className="relative overflow-hidden rounded-2xl border border-[#F3D9CE] bg-gradient-to-br from-[#FFF6F2] to-accent-soft px-6 py-7 sm:px-8 sm:py-9 text-center shadow-sm">
          ...
          <div className="relative space-y-2.5">
            ...
            <div className="flex items-center justify-center gap-2 pt-1">
              <span className="inline-flex items-center gap-1.5 rounded-full border border-accent/20 bg-card/70 px-3 py-1 text-xs font-semibold text-accent-hover">
                <Key size={12} /> {accounts.length} account{accounts.length === 1 ? '' : 's'}
              </span>
              <span className="inline-flex items-center gap-1.5 rounded-full border border-green-500/25 bg-card/70 px-3 py-1 text-xs font-semibold text-green-600">
        ...
        <div className="rounded-2xl border border-border-primary bg-card shadow-sm">
          <div className="px-5 py-4 border-b border-border-primary">
            <h2 className="text-sm font-semibold text-text-primary flex items-center gap-2">
              <Key size={14} className="text-accent" /> Select Trading Account
            </h2>
        ...
        {connectedKeys.length > 0 && (
          <div className="rounded-2xl border border-border-primary bg-card overflow-hidden shadow-sm">
            <div className="px-5 py-4 border-b border-border-primary">
              <h2 className="text-sm font-semibold text-text-primary flex items-center gap-2">
                <Radio size={14} className="text-accent" /> Connected Accounts ({connectedKeys.length})
              </h2>
            </div>
                  ...
                  <div key={a.account_id}>
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        {a.is_demo && <span className="px-1.5 py-0.5 rounded text-[10px] font-semibold bg-amber-500/100/15 text-amber-500">DEMO</span>}
                      </div>
        ...
        <div className="rounded-2xl border border-border-primary bg-card shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b border-border-primary">
            <h2 className="text-sm font-semibold text-text-primary flex items-center gap-2">
              <Terminal size={14} className="text-accent" /> Connect Your Bot
            </h2>
          ...
          <div className="p-5 space-y-4">
            ...
            <div className="flex items-start gap-2 rounded-lg border border-amber-500/20 bg-amber-500/100/5 px-3 py-2">
        ...
        {generatedKey && (
          <div className="fixed inset-0 bg-black/50 z-[100] flex items-center justify-center p-4" onClick={() => setGeneratedKey(null)}>
            <div className="bg-card border border-border-primary rounded-2xl p-6 max-w-md w-full space-y-5 shadow-2xl" onClick={e => e.stopPropagation()}>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-amber-500/100/10 flex items-center justify-center">
              ...
              <div className="rounded-lg border border-amber-500/20 bg-amber-500/100/5 px-3 py-2">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <code className="flex-1 text-xs bg-red-500/100/5 border border-red-500/20 rounded-lg px-3 py-2.5 font-mono text-red-400 break-all select-all">{generatedKey.api_secret}</code>
                    <button
